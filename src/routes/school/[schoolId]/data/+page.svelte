...
<svelte:head>
	<title>ข้อมูลโรงเรียน{d?.name_th ?? ' (ไม่พบชื่อ)'} — โรงเรียนโปร่งใส</title>
	<meta
		property="og:title"
		content="ข้อมูลโรงเรียน{d?.name_th ?? ' (ไม่พบชื่อ)'} — โรงเรียนโปร่งใส"
	/>
	<meta
		name="twitter:title"
		content="ข้อมูลโรงเรียน{d?.name_th ?? ' (ไม่พบชื่อ)'} — โรงเรียนโปร่งใส"
						...
						<summary>
							<span class="f">
								<img
									...
									height="16"
								/>
								<span>ดูลำดับวิทยฐานะและระดับตำแหน่งทั้งหมด</span>
								<img
									loading="lazy"
									decoding="async"
									class="chevron"
