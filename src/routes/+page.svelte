...
<section class="school-list-container">
	...
	<div class="school-list">
		<article class="f">
			<div>
				<div class="school-list-title">โรงเรียนร่วมใจศึกษา</div>
				<div class="school-list-date">โพสต์ล่าสุด 28/10/2022</div>
			</div>
		...
		<article class="f">
			<div>
				<div class="school-list-title">โรงเรียนศึกษาวิทยาการเรียนเจริญก้าวหน้า</div>
				<div class="school-list-date">โพสต์ล่าสุด 28/10/2022</div>
			</div>
			<div class="f header-score">
				<svg
		...
		<article class="f">
			<div>
				<div class="school-list-title">โรงเรียนโปร่งใสวิทยา</div>
				<div class="school-list-date">โพสต์ล่าสุด 28/10/2022</div>
			</div>
			<div class="f header-score">
				<svg
		...
		<article class="f">
			<div>
				<div class="school-list-title">โรงเรียนบ้านร่วมสร้าง</div>
				<div class="school-list-date">โพสต์ล่าสุด 28/10/2022</div>
			</div>
			<div class="f header-score">
				<svg
		...
		<article class="f">
			<div>
				<div class="school-list-title">โรงเรียนวัดป่าสามัคคี</div>
				<div class="school-list-date">โพสต์ล่าสุด 28/10/2022</div>
			</div>
			<div class="f header-score">
				<svg
...
<section class="origin">
	...
	<div class="f data-cards">
		...
		<div class="card">
			<h4>ข้อมูลบุคลากร</h4>
			<p>เช็คจำนวนครูมีสัดส่วนเท่าไหร่เมื่อเทียบกับนักเรียน</p>
		</div>
		<div class="card">
			<h4>ข้อมูลอุปกรณ์</h4>
